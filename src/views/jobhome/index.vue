  ...
  <el-card class="box-card">
    <template #header>
      <div class="card-header">
        <span class="header-title">求职信息</span>
        <router-link to="/user/getjob">
          <el-button type="primary">我也要求职 </el-button>
        </router-link>
      </div>
    </template>
    ...
    <el-card v-for="item in postJobList" :key="item.id" class="job-card">
      <el-row :gutter="20">
        <el-col :span="15">
